...
void HAL_ADC_MspDeInit(ADC_HandleTypeDef* hadc)
{
  ...
  /* USER CODE END ADC1_MspDeInit 0 */
    ...
    PA1     ------> ADC1_IN1
    */
    HAL_GPIO_DeInit(GPIOC, MQ135_SENSOR_Pin|WATER_LEVEL_Pin);

    HAL_GPIO_DeInit(GPIOA, LM35_ID0_Pin|LM35_ID1_Pin);
...
void HAL_UART_MspDeInit(UART_HandleTypeDef* huart)
{
  ...
  /* USER CODE END USART1_MspDeInit 0 */
    ...
    PA10     ------> USART1_RX
    */
    HAL_GPIO_DeInit(GPIOA, SERIAL_SIMCOM_TX_Pin|SERIAL_SIMCOM_RX_Pin);
  ...
  /* USER CODE END USART6_MspDeInit 0 */
    ...
    PA12     ------> USART6_RX
    */
    HAL_GPIO_DeInit(GPIOA, SERIAL_ENERGY_TX_Pin|SERIAL_ENERGY_RX_Pin);
